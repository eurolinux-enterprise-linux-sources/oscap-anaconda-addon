...
Source2:	oscap-anaconda-addon.ini

Patch0:         datastream_tailoring_1364929.patch
Patch1:         update_japanese_translation_1569449.patch
Patch2:	oscap-anaconda-addon_use_sl_stig.patch
Patch100:	eurolinux.patch
...
%changelog
* Wed Dec 12 2018 Aleksander Baranowski <aleksander.baranowski@euro-linux.com>
- EuroLinux Patch rebuild

* Tue Oct 30 2018 Scientific Linux Auto Patch Process <SCIENTIFIC-LINUX-DEVEL@LISTSERV.FNAL.GOV>
- Added Patch: oscap-anaconda-addon_use_sl_stig.patch
-->  "Use the SL SCAP guide"
- Added Source: oscap-anaconda-addon.ini
